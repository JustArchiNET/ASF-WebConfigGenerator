        ...
        asf: [
            ...
            },
            {
                ...
                fields: [
                    ...
                    {
                        type: 'InputCheckbox',
                        field: 'ShutdownIfPossible',
                        label: 'ShutdownIfPossible',
                        defaultValue: false
                    },
                    {
            ...
            },
            {
                ...
                fields: [
                    {
                        label: 'PluginsUpdateList',
                        field: 'PluginsUpdateList',
                        type: 'InputSet',
                        validator: Validators.string
                    },
                    {
                        label: 'PluginsUpdateMode',
                        field: 'PluginsUpdateMode',
                        type: 'InputSelect',
                        options: [
                            { value: 0, name: 'Whitelist' },
                            { value: 1, name: 'Blacklist' }
                        ],
                        defaultValue: 0
                    },
                    {
        ...
        bot: [
            ...
            },
            {
                ...
                fields: [
                    ...
                    {
                        type: 'InputNumber',
                        label: 'TradeCheckPeriod',
                        field: 'TradeCheckPeriod',
                        placeholder: 60,
                        validator: Validators.byte
                    },
                    {
            ...
            },
            {
                ...
                fields: [
                    ...
                    {
                        type: 'InputFlag',
                        label: 'FarmingPreferences',
                        field: 'FarmingPreferences',
                        values: [
                            { value: 0, name: 'None' },
                            { value: 1, name: 'FarmingPausedByDefault' },
                            { value: 2, name: 'ShutdownOnFarmingFinished' },
                            { value: 4, name: 'SendOnFarmingFinished' },
                            { value: 8, name: 'FarmPriorityQueueOnly' },
                            { value: 16, name: 'SkipRefundableGames' },
                            { value: 32, name: 'SkipUnplayedGames' },
                            { value: 64, name: 'EnableRiskyCardsDiscovery' },
                            { value: 256, name: 'AutoUnpackBoosterPacks' }
                        ],
                        defaultValue: 0
                    },
                    {
                ...
                fields: [
                    {
                        ...
                        values: [
                            ...
                            { value: 64, name: 'DisableIncomingTradesParsing' }
                        ],
                        defaultValue: 0
                    },
                    {
                    ...
                    {
                        type: 'InputFlag',
                        label: 'OnlinePreferences',
                        field: 'OnlinePreferences',
                        values: [
                            { value: 0, name: 'None' },
                            { value: 1, name: 'IsSteamDeck' }
                        ],
                        defaultValue: 0
                    },
                    {
                    ...
                    },
                    {
                        ...
                        options: [
                            { value: 0, name: 'VGUI' },
                            { value: 1, name: 'Tenfoot' },
                            { value: 2, name: 'Mobile' },
                            { value: 3, name: 'Web' },
                            { value: 4, name: 'ClientUI' },
                            { value: 5, name: 'MobileChat' },
                            { value: 6, name: 'EmbeddedClient' }
                        ],
                        defaultValue: 0
                    }
                ]
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        values: [
                            ...
                            { value: 32, name: 'SkipUnplayedGames' },
                            { value: 64, name: 'EnableRiskyCardsDiscovery' },
                            { value: 128, name: 'AutoSteamSaleEvent' },
                            { value: 256, name: 'AutoUnpackBoosterPacks' }
                        ],
                        defaultValue: 0
                    },
        ...
        bot: [
            ...
            },
            {
                ...
                fields: [
                    ...
                    {
                        type: 'InputCheckbox',
                        label: 'EnableRiskyCardsDiscovery',
                        field: 'EnableRiskyCardsDiscovery',
                        defaultValue: false
                    },
                    {
                        type: 'InputSet',
